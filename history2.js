...
try {
    const data = fs.readFileSync("history2_data.json", "utf8");
...
function startHistoryTest2(mainMenuCallback) {
    const fileName = "history2_results.json";
    let existingResults = [];
    ...
    let testNumber = existingResults.length + 1;
    ...
    if (userChoice.startsWith('y')) {
        startHistoryTest2(mainMenuCallback);
    } else {
...
module.exports = { startHistoryTest2 };